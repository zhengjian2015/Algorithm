package breakely.cs.b.homework3;
...
public class SList {
    ...
    public void squish() {
        ...
        while (size > 2 && currentNode.next!=null) {
            //currentNode.next = currentNode.next.next 理解不清晰，请参考玩转数据结构4-5
            if(currentNode.item.equals(currentNode.next.item)) {
                //currentNode.next = currentNode.next.next;
                SListNode delNode = currentNode.next;
    ...
    public void twin() {
        ...
        while (currentNode != null) {
            SListNode newo = new SListNode(currentNode.item);
            newo.next = currentNode.next;
            currentNode.next = newo;
            size++;
            //currentNode = currentNode.next会死循环，只要跳到
